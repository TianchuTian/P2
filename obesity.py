...
if st.session_state.prediction_result:
    st.success(f"✅ Your predicted obesity category is: **{st.session_state.prediction_result}**")
...
if st.session_state.shap_plot:
    ...
    **How to read this chart:**
    - **Base value**: The average prediction score over the entire training dataset.
    - **<span style="color:red;">Red arrows</span>**: Features that pushed the prediction score **higher** (risk factors for this prediction).
    - **<span style="color:blue;">Blue arrows</span>**: Features that pushed the prediction score **lower** (protective factors for this prediction).
    - The **length** of an arrow indicates the magnitude of that feature's impact on this specific prediction.
    """, unsafe_allow_html=True)
